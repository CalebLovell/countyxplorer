...
- `npm run clean` — Lint + format (biome) + typecheck (tsc); **always run after making changes**
...
- Run `npm run clean` after changes to catch lint/type errors before committing
